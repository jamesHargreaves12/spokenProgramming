...
def validate_ibmmode1():
    ...
    results = []
    for omega in [0.9,1.1,0.8,0.7,1.2,0.6,1.3,1.4]:
        message = "omega {}\n".format(omega)
...
if __name__  == "__main__":
    ...
    # results = [(0.5, 1019),(0.6,1019),(0.7,1019),(0.8,1016),(0.9,1015),(1.0, 1018),(1.1,1018),(1.2,1020),(1.5, 1020),(2.0, 1019),(2.5, 1019)]
    # So omega = 0.9
    print(results)

    # old_results = [(0.5, 1035),(0.7,1033),(0.8,1032),(0.9,1032),(1.0, 1032),(1.1,1035),(1.2,1035),(1.3,1034),(1.5, 1034),(2.0, 1037),(2.5, 1037)]
